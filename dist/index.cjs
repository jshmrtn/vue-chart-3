            ...
            newData.datasets.forEach((dataset, index) => {
              ...
              if (!(0, import_lodash_es.isEmpty)(dataset)) {
                ...
                for (const attribute in dataset) {
                  let keepInstancesIntactCloneCustomizer = function(value) {
                  ...
                  const attrValue = (0, import_lodash_es.cloneDeepWith)(dataset[attribute], keepInstancesIntactCloneCustomizer);
